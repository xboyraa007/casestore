...
<style> 
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/img/back.jpg">
														 ...
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">💰<?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-info"><span class=""  aria-hidden="true" >⏰</span> Order placed </button>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																				<button type="button" class="btn btn-warning"><span class=""  aria-hidden="true" >🚚</span> Delivered !</button>
																			<?php
																				}
																			if($status=="closed")
																				{
																			?>
																			 <button type="button" class="btn btn-success" ><span  class="" aria-hidden="true">✅</span> Paid</button> 
																			<?php 
																			} 
																			?>
																			<?php
														  ...
														  <td data-column="Date"> <?php echo $row['date']; ?></td>
														   <td data-column="Action"> <a href="delete_orders.php?order_del=<?php echo $row['o_id'];?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="" style="font-size:16px"></i>🗑️</a> 
															</td>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5 style="font-family:myFirstFont">លេខទរសព្វ: <a style="font-family:myFirstFont"> +855 713323326</a></a></h5> </div>
