        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/logos.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-gamepad" aria-hidden="true"></i><span class="hide-menu">Items</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <div class="col-md-3">
					 ...
					 <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-gamepad f-s-40" aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
